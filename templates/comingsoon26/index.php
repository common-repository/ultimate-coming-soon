...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url(UCSM_PLUGIN_URL_LITE . 'templates/comingsoon26/style.css?v=' . esc_attr($plugin_version)); ?>" /> 
            ...
            <div class="ucsm-bottom-box" style="display:flex; align-items: flex-end;">
                ...
                <div class="ucsm-bottom-content">                    
                    ...
                    <h1 class="ucsm-heading" style="color: #fff ;font-family: 'urbanist-extrabold';">
                        ...
                        <span style="color: #ffffff; font-family: 'urbanist-extrabold';"><?php echo wp_kses_post($wpucs_sub_heading); ?></span>
                    </h1>
                    <!--End Heading Text -->
                    <!-- Description Text -->
