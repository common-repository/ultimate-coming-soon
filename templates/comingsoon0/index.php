                ...
                <div class="ucsm-countdown" id="countdown-section">
                    ...
                    <div class="ucsm-countdown-item-lite">
                        <span class="ucsm-countdown-number-lite" id="hours"
                            style="background-color: #2DB456;color: #fff;height: 120px; width: 120px; border-radius: 5%; font-size: 50px;">
                            00</span>
                        <span class="ucsm-countdown-label-lite"
                            style="color: #fff; font-size: 15px;">
                    ...
                    <div class="ucsm-countdown-item-lite">
                        <span class="ucsm-countdown-number-lite" id="minutes"
                            style="background-color: #F58C31; color: #fff;height: 120px; width: 120px; border-radius: 5%; font-size: 50px;">
                            00</span>
                        <span class="ucsm-countdown-label-lite"
                            style="color: #fff; font-size: 15px;">
                    ...
                    <div class="ucsm-countdown-item-lite">
                        <span class="ucsm-countdown-number-lite" id="seconds"
                            style="background-color: #2966D1 ; color: #fff; height: 120px; width: 120px; border-radius: 5%;  font-size: 50px;">
                            00</span>
                        <span class="ucsm-countdown-label-lite"
                            style="color: #fff; font-size: 15px;">
